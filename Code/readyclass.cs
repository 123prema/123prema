...
public class readyclass
{
    ...
    public void sendSMS(string msg, string mobile)
    {
        try
        {
            HttpWebRequest myReq = (HttpWebRequest)WebRequest.Create("http://s.exonics.co.in/api/sendmsg.php?user=chetanpuc&pass=chetan12345678&sender=LKTECH&phone= " + mobile + "&text=" + msg + "&priority=ndnd&stype=normal");
